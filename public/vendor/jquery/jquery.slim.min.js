...
!((e, t) => {
	...
	ce.escapeSelector = (e) => (e + "").replace(f, d);
	var ye = m,
		me = s;
	!(() => {
		var e,
			...
			M = K((e) => !0 === e.disabled && fe(e, "fieldset"), {
				dir: "parentNode",
				next: "legend",
			});
		try {
		...
		function V(e) {
			...
			return (
				n != C &&
					...
					(le.disconnectedMatch = F((e) => i.call(e, "*"))),
					(le.scope = F(() => C.querySelectorAll(":scope"))),
					(le.cssHas = F(() => {
						try {
		...
		(I.contains = (e, t) => (
			(e.ownerDocument || e) != C && V(e), ce.contains(e, t)
		)),
		(I.attr = (e, t) => {
		...
		((x = ce.expr =
			{
				...
				filter: {
					...
					PSEUDO: (e, o) => {
						...
						return a[k]
							...
							: 1 < a.length
								? ((t = [e, e, "", o]),
									Object.hasOwn(x.setFilters, e.toLowerCase())
										? B((e, t) => {
												var n,
													r = a(e, o),
													i = r.length;
				...
				pseudos: {
					...
					parent: (e) => !x.pseudos.empty(e),
					header: (e) => j.test(e.nodeName),
					input: (e) => L.test(e.nodeName),
					button: (e) =>
		...
		ce.each(
			{
				...
				parents: (e) => p(e, "parentNode"),
				parentsUntil: (e, t, n) => p(e, "parentNode", n),
				next: (e) => D(e, "nextSibling"),
				prev: (e) => D(e, "previousSibling"),
				nextAll: (e) => p(e, "nextSibling"),
				prevAll: (e) => p(e, "previousSibling"),
				nextUntil: (e, t, n) => p(e, "nextSibling", n),
				prevUntil: (e, t, n) => p(e, "previousSibling", n),
	...
	var F = (e) => 1 === e.nodeType || 9 === e.nodeType || !+e.nodeType;
	function $() {
	...
	var Q = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		...
		K = m.documentElement,
		J = (e) => ce.contains(e.ownerDocument, e),
		Z = { composed: !0 };
	K.getRootNode &&
		(J = (e) =>
	...
	ce.extend({
		...
		(ce.cssHooks.marginLeft = Qe(le.reliableMarginLeft, (e, t) => {
			if (t)
				return (
	...
	(ce.param = (e, t) => {
		...
		ce.each(["top", "left"], (e, n) => {
			ce.cssHooks[n] = Qe(le.pixelPosition, (e, t) => {
				if (t)
	...
	(ce.proxy = (e, t) => {
		...
		(ce.trim = (e) => (null == e ? "" : (e + "").replace(Tt, "$1"))),
		"function" == typeof define && define.amd && define("jquery", [], () => ce);
	var Et = ie.jQuery,
		kt = ie.$;
	return (
		(ce.noConflict = (e) => (
			ie.$ === ce && (ie.$ = kt), e && ie.jQuery === ce && (ie.jQuery = Et), ce
		)),
