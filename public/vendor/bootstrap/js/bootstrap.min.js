...
!((t, e) => {
	...
	function e(e, t) {
		...
		if (Object.getOwnPropertySymbols) {
			...
			t &&
				(i = i.filter((t) => Object.getOwnPropertyDescriptor(e, t).enumerable)),
				n.push.apply(n, i);
		}
		return n;
	}
	...
	g(document).on(
		...
		(g.fn[r].noConflict = () => ((g.fn[r] = h), v._jQueryInterface));
	var y = "button",
		E = "bs.button",
		C = "." + E,
		T = ".data-api",
	...
	g(document)
		...
		(g.fn[y].noConflict = () => ((g.fn[y] = b), H._jQueryInterface));
	var R = "carousel",
		x = "bs.carousel",
		F = "." + x,
		U = ".data-api",
			...
			return (
				...
				(t.to = function (t) {
					...
					if (!(t > this._items.length - 1 || t < 0))
						if (this._isSliding) g(this._element).one(Y.SLID, () => this.to(t));
						else {
				...
				(t._getConfig = (t) => (
					(t = l({}, q, {}, t)), _.typeCheckConfig(R, t, M), t
				)),
				...
				(t._addEventListeners = function () {
					this._config.keyboard &&
						g(this._element).on(Y.KEYDOWN, (t) => this._keydown(t)),
						"hover" === this._config.pause &&
							g(this._element)
								.on(Y.MOUSEENTER, (t) => this.pause(t))
								.on(Y.MOUSELEAVE, (t) => this.cycle(t)),
				...
				(t._addTouchEventListeners = function () {
					if (this._touchSupported) {
						...
						g(this._element.querySelectorAll(rt)).on(Y.DRAG_START, (t) =>
							t.preventDefault(),
						),
							this._pointerEvent
								...
								: (g(this._element).on(Y.TOUCHSTART, (t) => n(t)),
									g(this._element).on(Y.TOUCHMOVE, (t) =>
										((t) => {
	...
	g(document).on(Y.CLICK_DATA_API, lt, ut._dataApiClickHandler),
		...
		(g.fn[R].noConflict = () => ((g.fn[R] = W), ut._jQueryInterface));
	var ft = "collapse",
		dt = "bs.collapse",
		gt = "." + dt,
		_t = g.fn[ft],
				...
				(t.show = function () {
					...
					if (
						...
						if ((g(this._element).trigger(i), !i.isDefaultPrevented())) {
							...
							g(this._element)
								.one(_.TRANSITION_END, () => {
									g(this._element).removeClass(Ct).addClass(Et).addClass(yt),
										(this._element.style[o] = ""),
										this.setTransitioning(!1),
										g(this._element).trigger(vt.SHOWN);
								})
	...
	g(document).on(vt.CLICK_DATA_API, It, function (t) {
		...
		(g.fn[ft].noConflict = () => ((g.fn[ft] = _t), wt._jQueryInterface));
	var At = "dropdown",
		Nt = "bs.dropdown",
		Ot = "." + Nt,
		kt = ".data-api",
	...
	g(document)
		...
		(g.fn[At].noConflict = () => ((g.fn[At] = Pt), ee._jQueryInterface));
	var ne = "modal",
		ie = "bs.modal",
		oe = "." + ie,
		re = g.fn[ne],
		...
		Te = (() => {
			...
			return (
					...
					if (!this._isShown && !this._isTransitioning) {
						...
						g(this._element).trigger(n),
							this._isShown ||
								...
								g(this._element).on(le.CLICK_DISMISS, ye, (t) => this.hide(t)),
								g(this._dialog).on(le.MOUSEDOWN_DISMISS, () => {
									g(this._element).one(le.MOUSEUP_DISMISS, (t) => {
				...
				(t._setResizeEvent = function () {
					this._isShown
						? g(window).on(le.RESIZE, (t) => this.handleUpdate(t))
					...
					(this._element.style.display = "none"),
						...
						this._showBackdrop(() => {
							g(document.body).removeClass(fe),
								...
								g(this._element).trigger(le.HIDDEN);
						});
				}),
				...
				(t._showBackdrop = function (t) {
					var n = g(this._element).hasClass(de) ? de : "";
	...
	g(document).on(le.CLICK_DATA_API, ve, function (t) {
		...
		(g.fn[ne].noConflict = () => ((g.fn[ne] = re), Te._jQueryInterface));
	var be = [
			"background",
			"cite",
			"href",
	...
	var Ae = "tooltip",
		...
		Xe = (() => {
			...
			return (
				...
				(t._getAttachment = (t) => Re[t.toUpperCase()]),
				...
				s(i, null, [
					...
					{ key: "DATA_KEY", get: () => Ne },
					{ key: "Event", get: () => We },
					{ key: "EVENT_KEY", get: () => Oe },
					{ key: "DefaultType", get: () => He },
				]),
				i
			);
		})();
	(g.fn[Ae] = Xe._jQueryInterface),
		...
		(g.fn[Ae].noConflict = () => ((g.fn[Ae] = ke), Xe._jQueryInterface));
	var $e = "popover",
		Ge = "bs.popover",
		Je = "." + Ge,
		Ze = g.fn[$e],
		...
		hn = ((t) => {
			...
			return (
				...
				s(i, null, [
					...
					{ key: "DATA_KEY", get: () => Ge },
					{ key: "Event", get: () => cn },
					{ key: "EVENT_KEY", get: () => Je },
					{ key: "DefaultType", get: () => on },
				]),
				i
			);
		})(Xe);
	(g.fn[$e] = hn._jQueryInterface),
		...
		(g.fn[$e].noConflict = () => ((g.fn[$e] = Ze), hn._jQueryInterface));
	var un = "scrollspy",
		fn = "bs.scrollspy",
		dn = "." + fn,
		gn = g.fn[un],
		...
		On = (() => {
			function n(t, e) {
				(this._element = t),
					...
					g(this._scrollElement).on(pn.SCROLL, (t) => this._process(t)),
					this.refresh(),
					this._process();
			}
			var t = n.prototype;
			return (
				(t.refresh = function () {
					var t = this._scrollElement === this._scrollElement.window ? An : Nn,
	...
	g(window).on(pn.LOAD_DATA_API, () => {
		...
		(g.fn[un].noConflict = () => ((g.fn[un] = gn), On._jQueryInterface));
	var kn = "bs.tab",
		Pn = "." + kn,
		Ln = g.fn.tab,
		jn = {
				...
				(t.show = function () {
					if (
						...
						if (
							...
							var l = () => {
								var t = g.Event(jn.HIDDEN, { relatedTarget: this._element }),
	...
	g(document).on(jn.CLICK_DATA_API, Qn, function (t) {
		...
		(g.fn.tab.noConflict = () => ((g.fn.tab = Ln), Yn._jQueryInterface));
	var zn = "toast",
		Xn = "bs.toast",
		$n = "." + Xn,
		Gn = g.fn[zn],
		...
		si = (() => {
			...
			return (
				(t.show = function () {
					var e = g.Event(Jn.SHOW);
					if ((g(this._element).trigger(e), !e.isDefaultPrevented())) {
						this._config.animation && this._element.classList.add(Zn);
						var n = () => {
							this._element.classList.remove(ni),
								this._element.classList.add(ei),
								g(this._element).trigger(Jn.SHOWN),
				...
				(t._setListeners = function () {
					g(this._element).on(Jn.CLICK_DISMISS, ri, () => this.hide());
				}),
				(t._close = function () {
					function t() {
	...
	(g.fn[zn] = si._jQueryInterface),
		...
		(g.fn[zn].noConflict = () => ((g.fn[zn] = Gn), si._jQueryInterface)),
		(t.Alert = v),
		(t.Button = H),
		(t.Carousel = ut),
		(t.Collapse = wt),
